...
// Untyped on purpose — see the comment in lib/supabase/client.ts.
...
// Service-role client — server-only. Used for admin actions like inviting
// clients by email. NEVER import this from a Client Component.
